        ...
        <div className='flex items-center justify-center gap-5'>
            ...
            <div className='flex gap-8 items-center text-xl'>
                ...
                <div className='relative'>
                    <BsBell/>
                    <span className='absolute bottom-2 left-2 text-xs bg-red-600 rounded-full px-1'>99+</span>
                </div>
                <img src='https://ashisheditz.com/wp-content/uploads/2024/03/cool-anime-pfp-demon-slayer-HD.jpg' alt='Account PFP' className='w-9 h-9 rounded-full'/>
            </div>
